...
**DClaw Energy** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8052` (FastAPI)
- **Frontend Port:** `3052` (Next.js)
- **Database:** `dclaw_energy` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3052`
